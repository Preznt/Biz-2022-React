 ...
 *      import 내 모듈 from "모듈.js" 형식으로 사용하는 곳에서 이름을 명령할수 있다
 * 2. export { 모듈 }
 *      반드시 내가 export 한 이름으로 import 를 수행해야 한다
 *      이때 구조 분해를 한다
 *      import { 모듈 } from "모듈.js"
 *
 *      이 방법으로 export 하면 하나의 모듈 파일에서 다수의 모듈들(변수, 객체, 배열. 함수)
 *      export 할 수 있다
 *
 *      이 경우 사용하는 곳에서 굳이 이름을 변경하려고 하면
 *      import { 모듈 as 내 모듈 } from "모듈.js" 처럼 사용한다.
 *
 */
